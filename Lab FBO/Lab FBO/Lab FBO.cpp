...
void draw_pass_2()
{
   ...
   int screen_loc = glGetUniformLocation(shader_program, "screenTexture");////////////////////////////////////////////////////////////////////////////////////
   if (tex_loc != -1)
   {
       glUniform1i(screen_loc, 0); // we bound our texture to texture unit 0
   }
...
void reload_shader()
{
   ...
   else
   {
      ...
      //glClearColor(0.35f, 0.0f, 0.35f, 0.0f);
...
void initOpenGl()//////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
{
   ...
   if (screen_loc >= 0) {
       ...
       glVertexAttribPointer(screen_loc, 3, GL_FLOAT, false, 0, 0);
   }
   ...
   glFramebufferTexture2D(GL_FRAMEBUFFER, GL_COLOR_ATTACHMENT0, GL_TEXTURE_2D, fbo_texture, 0);////////////////////////////////////////////////////////change 0  to 1
   ...
   glBindFramebuffer(GL_FRAMEBUFFER, 0);////////////////////////////////////////////////////////////////////////////////////change 0  to 1
